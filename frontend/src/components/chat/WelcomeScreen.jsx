...
const WelcomeScreen = ({ onSelectTopic, hasMessages }) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-6">
        <div className="mb-8">
          ...
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3 text-xl-large">
            Welcome to Dementia Support
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-8 text-large">
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="mb-8">
        <div className="relative">
          <Brain className="w-20 h-20 text-blue-600 dark:text-blue-400 mb-6 mx-auto animate-pulse" />
        </div>
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4 text-xl-large">
          Welcome to Dementia Support
        </h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-lg text-large">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full">
        <div 
          ...
          onClick={() => onSelectTopic('What are the early signs and symptoms of dementia?')}
        >
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Knowledge Agent</h3>
            <p className="text-gray-600 dark:text-gray-400 text-large">
        ...
        <div 
          className="card-interactive group cursor-pointer"
          onClick={() => onSelectTopic('I need support with caregiving challenges')}
        >
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Empathy Agent</h3>
            <p className="text-gray-600 dark:text-gray-400 text-large">
        ...
        <div 
          className="card-interactive group cursor-pointer"
          onClick={() => onSelectTopic('Please provide a cognitive exercise')}
        >
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Cognitive Agent</h3>
            <p className="text-gray-600 dark:text-gray-400 text-large">
      ...
      <div className="mt-12 p-6 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-2xl border-2 border-blue-200 dark:border-blue-700">
        <p className="text-gray-700 dark:text-gray-300 text-large font-medium">
